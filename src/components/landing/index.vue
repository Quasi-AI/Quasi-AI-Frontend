  ...
  <div class="z-10 xl:mx-auto 2xl:w-[1440px]">
    ...
    >
      ...
      >
        ...
        >
          {{ useAuthToken ? 'Dashboard' : 'Sign up now' }}
        </NuxtLink>
      </div>
    ...
    >
      ...
      <div class="grid w-full gap-3 sm:grid-cols-1 md:grid-cols-2 lg:max-w-4xl">
        ...
        >
          ...
          <NuxtLink :to="useAuthToken ? '/other/plan' : '/auth/sign-up'">
            <button
