<template>
  <div
    class="fixed bottom-0 left-0 flex w-full bg-white py-2 shadow-lg md:hidden dark:bg-[#111C44]"
  >
    <div class="grid w-full grid-cols-5">
      <NuxtLink
        ...
        :class="{ 'text-[#5D3BEA]': isActive(item.route) }"
      >
...
const menuItems = [
  ...
  { fullLabel: 'Apps', mobileLabel: 'Apps', route: '/apps', icon: CubeIcon },
  {
    fullLabel: 'Games',
    mobileLabel: 'Games',
    route: '/games',
