<template>
  <div class="container mx-auto px-4 py-16">
    ...
    <div class="prose dark:prose-invert mx-auto mb-16 max-w-3xl">
      ...
      <section class="mb-8">
        <h2 class="mb-4 text-2xl font-semibold text-[#5D3BEA]">Introduction</h2>
        <p>
          At Quasi AI, we respect your privacy and are committed to protecting
          your personal data. This Privacy Policy explains how we collect, use,
          and safeguard your information when you use our educational platform
          and services.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc space-y-2 pl-6">
          <li>
            ...
            profile image when you create an account
          </li>
          <li>
            <strong>Usage Data:</strong> Information about how you interact with
            our platform, including flashcards, quizzes, and questions you
            create
          </li>
          <li>
            <strong>Learning Content:</strong> Educational materials you upload
            or create using our services
          </li>
          <li>
      ...
      <section class="mb-8">
        <h2 class="mb-4 text-2xl font-semibold text-[#5D3BEA]">Your Rights</h2>
      ...
      <section class="mb-8">
        <h2 class="mb-4 text-2xl font-semibold text-[#5D3BEA]">Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, please contact us
          at:
          <a href="mailto:privacy@quasiai.com" class="text-[#5D3BEA]"
            >privacy@quasiai.com</a
          >
        </p>
      </section>
    </div>
